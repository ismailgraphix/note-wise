...
const TOAST_LIMIT = 1
// Removed TOAST_REMOVE_DELAY as it's not used
...
// Define action types as an object for type safety
const ACTION_TYPES = {
  ADD_TOAST: "ADD_TOAST",
  ...
  switch (action.type) {
    ...
    case ACTION_TYPES.DISMISS_TOAST: {
      ...
      if (toastId) {
        ...
        const entries = Array.from(toastTimeouts.entries())
        for (const [id, timeout] of entries) {
